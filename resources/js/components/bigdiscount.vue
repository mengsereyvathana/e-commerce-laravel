...
const getProduct = async () => {
    ...
    products.value = respone.data.result.sort((a, b) => b.discount - a.discount);
}
    ...
    <div class="mt-10">
        <div class="flex justify-between items-end">
            <div class="flex items-center">
                <img :src="'/icons/bigdiscount.png'" alt="" class='w-8 h-8 mr-1' />
                <span class='text-2xl font-[700] text-gray-800 capitalize'>Big Discount</span>
            </div>
